...
def test_dense_1d():
    ...
    model.fit(np.random.random((32, 16, 16)), np.random.random((32, 16, 16 + 8 * 2)))
...
def test_dense_2d():
    ...
    model.compile(optimizer="adam", loss="mse")
    model.fit(
        np.random.random((32, 16, 16, 16)), np.random.random((32, 16, 16, 16 + 8 * 2))
    )
...
def test_dense_3d():
    ...
    model.fit(
        ...
        np.random.random((32, 16, 16, 16, 16 + 8 * 2)),
    )
